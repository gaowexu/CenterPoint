...
# For Carla simulation environment
...
CenterPointConfig = {
    ...
    "VOXEL_SIZE": [0.16, 0.16, 4.0],
    "HEAD_INPUT_CHANNELS": 384,
    "MODEL_SAVE_ROOT_DIR": "../carla_weights/",

    "DATASET_CONFIG": {
        "RAW_DATASET_ROOT_DIR": "../carla_dataset",
        "GT_OBJECTS_SAVE_ROOT_DIR": "../carla_db_info/train_gt_objects/",
        "TRAIN_CATEGORY_GT_LUT_FULL_PATH": "../carla_db_info/train_category_gt_lut.json",
        "TRAIN_SAMPLES_LABEL_ROOT_DIR": "../carla_db_info/train/",
        "VAL_SAMPLES_LABEL_ROOT_DIR": "../carla_db_info/val/",
        "FILTER_BY_MIN_POINTS": [
            ("car", 8),
        ],
        "FILTER_BY_DIFFICULTY": [0, 1, 2],
